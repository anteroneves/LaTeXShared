...
% Tamanhos de referência para posts em social media 2021
	% Quadrados
...
\begin{document}
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		%\node[anchor=south,outer sep=0pt,inner sep=0pt](LMCoracao) at ([xshift=-2*\margem,yshift=1*\margem-40]current page.south east) {\includegraphics[height=120pt]{LMCoracao.pdf}};
		...
		%\node[anchor=south,white,yshift=2mm,scale=1.2](Conta) at (current page.south) {FB: \url{fb.com/matlingua} \qquad IG: Linguagem Matemática};
